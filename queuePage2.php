                    ...
                    <table class="center">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $file) : ?>
                                <tr>
                                    <td><?php if ($file['coursename'] == 'EECS 280 Data Structure') echo $file['id']; ?></td>
                                    <td><?php if ($file['coursename'] == 'EECS 280 Data Structure') echo $file['name']; ?></td>
                                    <td><?php if ($file['coursename'] == 'EECS 280 Data Structure') echo $file['question']; ?></td>
                                    <td><?php if ($file['coursename'] == 'EECS 280 Data Structure') {
